/* CONFIGURATION STARTS HERE */
  ...
  const MY_DOMAIN = 'sixeleven.in';
  const MY_NOTION_DOMAIN = "rishitvora";
  /*
  ...
  const SLUG_TO_PAGE = {
    ...
    'analysis-2': '38f28424f13f4ee49a40edf2a52b4f8a',
    'monty-hall': '5b7640ea3be641babb6e669ec22653d9',
    'work': '70ab09376fbd4fa4bf5f51e029473b24',
    'currying': '020bee1f5d0b474ba22554668bdf859c',
    'codex': 'a91e5ceff8f44e1f8cf0e91d3164f58d',
  ...
  async function fetchAndApply(request) {
    ...
    if (url.pathname.endsWith('js')) {
      ...
      response = new Response(body.replace(/www.notion.so/g, MY_DOMAIN).replace(/notion.so/g, MY_DOMAIN).replace(/${MY_NOTION_DOMAIN}.notion.site/g, MY_DOMAIN), response);
    ...
    element(element) {
      ...
      if (TWITTER_HANDLE != '') {
        if (element.getAttribute('name') === 'twitter:site') {
          element.setAttribute('content', TWITTER_HANDLE)
        }
      }
      if (PAGE_DESCRIPTION !== '') {
  ...
  class HeadRewriter {
    element(element) {
      ...
      div.notion-page-controls > div {display: none !important; }
    ...
    //   div.notion-topbar-mobile > div:nth-child(4) { display: block !important; }
